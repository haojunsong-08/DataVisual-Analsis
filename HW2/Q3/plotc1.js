...
//-----------------------------AXES-----------------------------//
// add axis to svg
svg_c1.select('#plot-c-1').append('g')
.attr('id', 'x-axis-c-1')
...
//add text to axis
svg_c1.select('#x-axis-c-1').append('text')
.attr("x", width/2)
.attr('y', height+50)
.style("font-weight", "bold")
.style('fill','black')
...
.text('Month')
svg_c1.select('#y-axis-c-1').append("text")
.attr("x", 0 - height / 2)
.attr("y", -50)
.style("font-weight", "bold")
.style('fill','black')
...
//----------------------------Symbols --------------------------//
symbol = svg_c1.select('#plot-c-1').append('g')
.attr('id', 'symbols-c-1')
...
//----------------------------LEGENDS-------------------------------//
let legend = svg_c1.select('#plot-c-1').append('g')
                .attr("id", "legend-c-1")
...
//add lines to svg
svg_c1.select('#lines-c-1').append('path')
.datum(data)
